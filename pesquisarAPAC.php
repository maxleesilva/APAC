                           ...
                           $result_pac = pg_query($conexao, $result_pac);
                            ...
                            while($rows_pac = pg_fetch_row($result_pac)){
                                        ...
                                        echo    "<tr>
                                                ...
                                                <td>".date('d/m/Y', strtotime($rows_pac[2]))." &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a type='button' class='btn btn-primary btn-sm' href='editarValidade.php?data_validade=$pesquisar'>Editar &nbsp; <i class='far fa-edit'></i></a></td>
                                                </tr>";
                                        echo    "<tr>
                                                <td>Código do SUS: </td>
                                                <td>".$rows_pac[3]."</td>
